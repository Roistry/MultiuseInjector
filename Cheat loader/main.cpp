...
DWORD Window(ImGuiD3d9Window* mainWindow)
{
    ...
    patchNotesDateManager.vecPatchNotesDates.push_back(PatchNotesDate{ "4/14/2023", "https://cdn.discordapp.com/attachments/765166083401187338/1096343476448268348/4-14-2023_Cheat_loader.exe", "1. Removed default games in game\nlist tab\n\n2. Removed Del key intentially closing\nthe loader.\n\n3. Program wont crash if there is 0\ngames in game list tab, did the same\nin game list tab.\n\n4. Didnt realise last build that the\ninjecting will only work on x64 so i\nmade if x64 and x86 compatible.\n\n5. If you left Game Engine in AddGame\nblank it will stay blank so i fixed it\nto be like the others and it will be\nNone instead.\n\n6. Added a config system that you can\ncontroll in the Settings tab, there you\ncan choose what to load upon opening\nthe injector.\n\n7. Removed imgui ini file.\n\n" });
    patchNotesDateManager.vecPatchNotesDates.push_back(PatchNotesDate{ "0/0/2023", " ", "1. Added QueueUserAPC for x64.\n\n" });
