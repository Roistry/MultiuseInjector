...
namespace ImGui
{
    ...
    IMGUI_API bool          InputText(const char* label, char* buf, size_t buf_size, ImVec2 size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
